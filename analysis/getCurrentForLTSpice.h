...
// Wed Jan 19 23:05:07 2022 by ROOT version 6.24/06
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   vector<double>  *phit_start_x;
   vector<double>  *phit_start_y;
   vector<double>  *phit_start_z;
   vector<double>  *phit_start_t;
   vector<double>  *phit_end_x;
   vector<double>  *phit_end_y;
   vector<double>  *phit_end_z;
   vector<double>  *phit_end_t;
   vector<double>  *InstCurrent;
   vector<double>  *CumCurrent;
   ...
   TBranch        *b_phit_start_x;   //!
   TBranch        *b_phit_start_y;   //!
   TBranch        *b_phit_start_z;   //!
   TBranch        *b_phit_start_t;   //!
   TBranch        *b_phit_end_x;   //!
   TBranch        *b_phit_end_y;   //!
   TBranch        *b_phit_end_z;   //!
   TBranch        *b_phit_end_t;   //!
...
void getCurrentForLTSpice::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("phit_start_x", &phit_start_x, &b_phit_start_x);
   fChain->SetBranchAddress("phit_start_y", &phit_start_y, &b_phit_start_y);
   fChain->SetBranchAddress("phit_start_z", &phit_start_z, &b_phit_start_z);
   fChain->SetBranchAddress("phit_start_t", &phit_start_t, &b_phit_start_t);
   fChain->SetBranchAddress("phit_end_x", &phit_end_x, &b_phit_end_x);
   fChain->SetBranchAddress("phit_end_y", &phit_end_y, &b_phit_end_y);
   fChain->SetBranchAddress("phit_end_z", &phit_end_z, &b_phit_end_z);
   fChain->SetBranchAddress("phit_end_t", &phit_end_t, &b_phit_end_t);
   fChain->SetBranchAddress("InstCurrent", &InstCurrent, &b_InstCurrent);
   fChain->SetBranchAddress("CumCurrent", &CumCurrent, &b_CumCurrent);
   Notify();
}
